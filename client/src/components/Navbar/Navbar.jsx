  ...
  render() {
    ...
    return (
      <div className="navbarBlack">
        ...
        {isLoggedIn ? (
          <button
            className="active loginPageButton"
            onClick={() => this.logoutUserHandler()}
          >
            Logout
          </button>
        ) : (
          <a className="active loginPageButton navfloatright" href="/login">
            Login
          </a>
        )}
        <a href="/" className="navLogoName">
          DwellDuo
        </a>
        <a className="navfloatright" href="mailto: zohaibxrehman@gmail.com">
          Support
        </a>
        {/* Once authentication is added, page will redirect to user dashboard if user logged
                ...
                */}
        {!isLoggedIn && (
          <a className="navfloatright" href="/login">
            Dashboard
          </a>
        )}
        {isLoggedIn && currentUser === "admin" && (
          <a className="navfloatright" href="/admindashboard">
            Dashboard
          </a>
        )}
        {isLoggedIn && currentUser !== "admin" && (
          <a className="navfloatright" href="/userdashboard">
            Dashboard
          </a>
        )}
        <a className="navfloatright" href="/finder">
          Posting
        </a>
        <a className="navfloatright" href="/">
          Home
        </a>
      </div>
    );
