...
import bigPhoto from '../../assets/bigphoto.webp';
      ...
      <div className="midLP">
        ...
        <div className="lowLP_container1">
         ...
         <div className="lowLP_container_text">
            Find your perfect flat with DwellDuo's extensive collection of verified listings and immersive photo experience.
            </div>
